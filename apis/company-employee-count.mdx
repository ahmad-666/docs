...
sidebarTitle: Company Employee Count
---
...
<div>
    <div className="grid gap-4 grid-cols-12">
            ...
            <div className='border rounded-xl p-2 border-gray-200 overflow-hidden'>
                <div className="flex justify-between flex-wrap gap-4 items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <p className="!my-0 ml-2 text-base text-gray-800 dark:text-white font-medium">https://api.cufinder.io/v2/cec</p>
                    </div>
                </div>
            </div>
        ...
        <div className="col-span-12 lg:col-span-7">
            <CodeGroup dropdown>
                ```bash Request
                curl --location 'https://api.cufinder.io/v2/cec' \
                ...
                fetch("https://api.cufinder.io/v2/cec", requestOptions)
                ...
                url = "https://api.cufinder.io/v2/cec"
                ...
                $request = new Request('POST', 'https://api.cufinder.io/v2/cec', $headers);
